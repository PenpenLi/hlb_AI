...
def main():
    ...
    cxx_generator_root = os.path.abspath(os.path.join(tool_dir, 'bindings-generator'))
	
    # save config to file
    config = ConfigParser.ConfigParser()
    config.set('DEFAULT', 'projdir', project_root)
    ...
    try:
        ...
        cmd_args = {'toLuaList.ini' : ('toLuaList', 'toLuaList_auto'),
                    }
        target = 'lua'
